...
//     let differenceOfNumbers = Math.abs(endOfTheNumberRange - startOfTheNumberRange);
//     if (startOfTheNumberRange < endOfTheNumberRange && (differenceOfNumbers>=5)){
//         for(let i = startOfTheNumberRange; i < endOfTheNumberRange; i++ ){
//             iterationCounter++
//             console.log(+i);
//         };
//     };
//     if (endOfTheNumberRange < startOfTheNumberRange && (differenceOfNumbers>=5)){
//         for(let i = endOfTheNumberRange; i < startOfTheNumberRange; i++ ){
//             iterationCounter++
//             console.log(+i);
//         };
//     };
//     if(differenceOfNumbers < 5){
...
// let pinFromUser;
// let pukFromUser;
// while(pin != pinFromUser && puk != pukFromUser && pinIterationCounter != 3 && pukIterationCounter != 3){
// while (pin != pinFromUser && pinIterationCounter != 3){
//     pinFromUser = prompt ('enter PIN code');
//     if (pin != pinFromUser){
//         pinIterationCounter++
...
//     }
//     if (puk == pukFromUser){
//         alert('correct puk, welcome');
//     }
//     if (pin != pinFromUser  && pinIterationCounter == 3 && puk != pukFromUser && pukIterationCounter == 3){
//         alert ('wrong PIN and PUK code');
//     }
// };
// };
